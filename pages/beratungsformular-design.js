  ...
  if (process.browser) {
    ...
    return (
      <Layout>
        ...
        <div id='arrow-img'>
          <img src='/img/Arrow24Yellow.svg' alt='' />
        </div>
        <div id='sign-up'>
          <div id='form'>
            <HubspotForm
              portalId='5807040'
              formId='2ca8d405-fdf0-45d1-bb91-cb793b74ca51'
        ...
        * {
        ...
        .willkommen .after-span {
          content: '';
          background: url('/img/stricheYellow.svg') 0px 120px / contain no-repeat;
        }
        .strich {
          padding-bottom: 2rem;
          ...
          content: '';
          background: url('/img/stricheYellow.svg') -7px 30px / contain no-repeat;
        }
