const CertquaBonn = () => {
  return (
    <div id="header-call">
      <h2>
        “SuperCode bietet ein arbeitsmarktlich aussichtsreiches und <br />{" "}
        praxisnahes Bildungsangebot im IT-Bereich mit methodisch <br /> modernen
        und hohem Einsatz von Lehrpersonal. Hervorzuheben <br /> ist die
        hervorragende Branchenvernetzung sowie die innovative <br />{" "}
