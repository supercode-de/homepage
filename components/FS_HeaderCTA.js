    ...
    return (
      <div id="header-call">
        <section className="headerFlex">
          <section>
            <h3>– 22 Wochen = <span className="circle"> 5 Monate</span></h3>
            <h3>– Tägliches Training</h3>
            <h3>– 2 Trainer*innen <span className="after-span">jeden Tag.</span></h3>
          </section>
          <section>
            <h3>– Moderner Campus</h3>
            <h3>– <span className="bling">Eigenes </span><span className="bling2">Macbook*</span></h3>
            <h3>– Vor Ort & online</h3>
            <p>*Du erhälst von uns bei Bedarf ein Macbook Air als Leihgabe.</p>
          </section>
        </section>
        <style jsx>{`
        #header-call {
        ...
        h3 span.bling::before, h3 span.bling2::after {
          position: absolute;
          content: "";
          display: block;
          height: 2.5rem;
