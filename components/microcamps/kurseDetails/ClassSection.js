        ...
        <section className="classSection">
            <div className="wrap">
                <article className="classSection__headline">
                    ...
                    <h3>Werde Teil des {theme === "design" ? "UX/UI-" : theme === "coding" ? "Web-Development-": theme === "data" ? "Data-" : ""}MicroCamps mit</h3>
                    <h3>Teilnehmenden aus ganz Deutschland</h3>
                    <p>
                    Wir sind der Meinung, dass eine persönliche Lernerfahrung sehr wichtig ist und begrenzen die Kursgröße bewusst auf 0 Teilnehmer:innen. So können wir in der kurzen Zeit mehr abdecken und du lernst direkt von anderen Teilnehmenden. Außerdem achten wir auf ein freundliches und respektvolles Miteinander mit viel Austausch und Feedback, damit das MicroCamp für dich zu einer großartigen Erfahrung wird. 
                    </p>
                </article>
