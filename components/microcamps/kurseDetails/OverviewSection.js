const OverviewSection = (props) => {
    ...
    // let wochenAnzahlKleinerZehn = Number(duration.slice(0,1))
    // let wochenAnzahlGroesserZehn = Number(duration.slice(0, 2))
    return (
        <section className="overviewSection" id="overviewSection">
            <div className="wrap">
                <article className="overviewSection__textarea">
                    ...
                    {/* <p>Unser MicroCamp für {subTheme} bietet dir eine intensive {wochenAnzahlKleinerZehn > 10 ? wochenAnzahlKleinerZehn : wochenAnzahlGroesserZehn}-wöchige Lernerfahrung, die dich aufs nächste Level bringt!</p> */}
