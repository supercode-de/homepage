const blog9 = `# “Ist das Kunst oder kann das web?”
*Eine online Kunstgalerie, ein Finanzplattform und eine Cocktail-Webseite - das sind die schicken Frontend-Projekte unserer Teilnehmenden aus dem aktuellen Full-Stack-Bootcamp, die sie am Freitag stolz präsentiert haben. Aber seht selbst!*
...
Für dieses anspruchsvolle Projekt mussten die Teilnehmende einige Daten-Schnittstellen (sogenannte APIs) anzapfen, haben fleißig mit HTML, CSS und Javascript gecodet und das Ergebnis kann sich coding-technisch und optisch absolut sehen lassen. Well done! [https://quizzical-visvesvaraya-271282.netlify.app/](https://quizzical-visvesvaraya-271282.netlify.app/)
...
Die Cocktail-Seite ist in einem schönen schwarz gehalten und bietet neben einer Rubriksuche nach z.B. Rum, Gin oder Wodka, einen Button zur zufälligen Cocktail-Inspiration. Besonders die mobile Version bietet eine schicke Übersicht, die direkt Lust aufs Einkaufen der Zutaten macht und bei Bedarf die Zutaten sogar direkt online bestellt. Zugegriffen wird eine Cocktail-Datenschnittstelle (API), die die Daten für die Rezepte liefert. Programmiert ist die Seite mit HTML, CSS sowie Javascript mit React.js. Zukünftig soll es auch noch eine Suche geben, um bekannte Cocktails einzugeben und anschließend seine Favoriten zu speichern. Außerdem ist ein Bewertungssystem für die einzelnen Rezepte in Planung. Der Name der Seite erschließt sich übrigens aus den Haupt-Rubriken der Alkohol-Sorten, die fast alle über 40% Schuss haben. 
Und noch ein kleines Goodie obendrauf: Mit einem QR-Code kommt man direkt auf die Seite! Los gehts:  [https://forty-cocktail.netlify.app/](https://forty-cocktail.netlify.app/) (+QR-Code)

![blog9](/img/blogs/9/image1.png)

![blog9](/img/blogs/9/image2.png)


Wow! Und nun? 
Auch dieses mal zeigten unsere Teilnehmenden, was nach 3 Monaten intensiven Lernens im Bereich Webentwicklung möglich ist! Nun geht es weiter mit Modul 2 - dem Backend-Bereich und schon bald werden unsere IT-Talente der Zukunft den Arbeitsmarkt erobern. Wir sind sehr stolz auf euch und eure Projekte, die ihr komplett remote, fast ohne Hilfestellung und hoch motiviert umgesetzt habt!
  
Das willst du auch können? Dann meld dich schnell bei SuperCode und starte deine digitale Karriere als Webentwickler*in!
