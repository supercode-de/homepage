...
**facebook/pixel**
Diese Komponenten werden für das Page Tracking via Facebook verwendet. Die Komponente <Pixel1 /> muss an der Stelle eingebunden werden, an der das Tracking passieren soll. Aktuell ist das bei unserer /danke Seite der Fall.
